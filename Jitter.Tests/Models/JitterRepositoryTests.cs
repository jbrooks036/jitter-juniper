...
namespace Jitter.Tests.Models
{
    ...
    public class JitterRepositoryTests
    {
        ...
        public void JitterRepositoryEnsureICanSearchByName()
        {
            ...
            // Assert
            // N.B. iCollection.SortBy does not make Assert work very well.
            Assert.AreEqual(expected_users[0].Handle, actual_users[0].Handle);
            Assert.AreEqual(expected_users[1].Handle, actual_users[1].Handle);
        ...
        // Data source, create jots, put them in ds; then see if they're in there, and in right order. And finally, delete.
        // Do read first, before know how to do create, delete.
        ...
        public void JitterRepositoryEnsureICanGetAllJots()
        {
            ...
            // first, make jots comparable before executing next two lines
            expected_jots.Sort();
            actual_jots.Sort();
        ...
        [TestMethod]
        // this begins to allow us to do all the important things we want
        public void JitterRepositoryEnsureICanCreateAJot()
        {
            ...
            // what's new next is mock setup w/ argument
            // listen for "Jot.Add()"
